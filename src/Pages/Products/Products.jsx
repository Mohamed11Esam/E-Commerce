...
<div className="max-w-sm flex items-center gap-3">
  <label htmlFor="sort" className="block mb-2 text-sm font-medium text-main"><FaFilter size={24} /></label>
  <select id="sort" onChange={handleSort} defaultValue={sort} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
    ...
    <option value="-title">Name Z TO A</option>
      ...
      <ReactPaginate
        ...
        pageCount={resurlts.metadata?.numberOfPages}
